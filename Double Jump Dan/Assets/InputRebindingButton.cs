...
public class InputRebindingButton : MonoBehaviour
{
    ...
    private void PerformInteractiveRebind(InputAction action, int bindingIndex, bool allCompositeParts = false)
    {
        ...
        m_RebindOperation = action.PerformInteractiveRebinding(bindingIndex)
            .OnCancel(operation =>
            {
                ...
                StartCoroutine(DelayInputRebinding());
        ...
        // Apply control filters based on binding type
        if (isGamepadBinding)
        {
            if (isJoystickRebind)
            {
        ...
        if (m_RebindText != null)
        {
            ...
            if(action.bindings[bindingIndex].isPartOfComposite)
            {
                ...
                waitingMessage = isJoystickRebind ? "Move any joystick..." : "Press any button...";
            else
                waitingMessage = "Press any key or mouse button...";
    ...
    IEnumerator DelayInputRebinding()
    {
    ...
    public Image m_ControllerButtonImage;
    ...
    private static List<InputRebindingButton> s_RebindActionUIs;
