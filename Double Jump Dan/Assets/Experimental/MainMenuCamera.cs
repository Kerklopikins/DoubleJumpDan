...
//         while(inTime < barScaleDuration)
//         {
//             inTime += Time.unscaledDeltaTime;
//             healthBarFillPivot.transform.localScale = Vector3.Lerp(healthBarFillPivot.transform.localScale, Vector3.one, inTime / barScaleDuration);
//             extraHealthBarFillPivot.transform.localScale = Vector3.Lerp(extraHealthBarFillPivot.transform.localScale, Vector3.one, inTime / barScaleDuration);
